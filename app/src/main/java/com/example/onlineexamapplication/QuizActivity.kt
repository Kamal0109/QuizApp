...
import com.example.onlineexamapplication.databinding.ActivityQuizBinding
...
class QuizActivity : AppCompatActivity() {
        ...
        databaseReference.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (questionNumber <= questionCount){
                    ...
                    dialogMessage.setTitle("Online Exam App")
                    ...
                    dialogMessage.setNegativeButton("Solve Again"){ dialogWindow,position ->
    ...
    fun  updateCountDownText(){
        ...
        quizBinding.textViewtTme.text = remainingTime.toString()
