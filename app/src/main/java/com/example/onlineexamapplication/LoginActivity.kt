...
import com.example.onlineexamapplication.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val textOfGoogleButton = loginBinding.butttonGoogleSignin.getChildAt(0) as TextView
        ...
        loginBinding.butttonGoogleSignin.setOnClickListener {
    ...
    fun signInUser(userEmail: String, userPassword : String) {
        ...
        auth.signInWithEmailAndPassword(userEmail, userPassword).addOnCompleteListener { task ->
            ...
            if (task.isSuccessful) {
                Toast.makeText(applicationContext, "Welcome to Online Exam App", Toast.LENGTH_SHORT).show()
    ...
    private fun signInGoogle(){
        ...
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            .requestIdToken("271587891839-rbfai1tjrgfeqt13cvgarms6f129jemt.apps.googleusercontent.com")
            .requestEmail().build()
